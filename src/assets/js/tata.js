  ...
  function (t, n, r) {
    ...
    function u(t, n, r) {
      ...
      var v =
        ...
        '" id=' +
        l +
        '>\n    <i class="tata-icon material-symbols-outlined">' +
        u +
        '</i>\n    <div class="tata-body">\n      <p class="tata-text">' +
        n +
        '</p>\n    </div>\n    ' +
        (r.closeBtn || r.holding
          ? '<button class="tata-close material-symbols-outlined">clear</button>'
          : '') +
        '\n    ' +
      ...
      if (
        (!!r.onClick &&
          ...
          b.addEventListener('click', c.bind(m), {
            capture: !0,
            once: !0,
          }),
